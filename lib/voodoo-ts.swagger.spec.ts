...
describe('OpenAPI', () => {
  ...
  it('should generate correct schemas', () => {
    ...
    expect(propData).toEqual({
      ...
      testEmbed: { type: Embed, required: true, isArray: false },
      testPick: { type: '#/components/schemas/Pick<Embed, name>', required: true, isArray: false },
      testOmit: { type: '#/components/schemas/Omit<Embed, name>', required: true, isArray: false },
      testPartial: { type: '#/components/schemas/Partial<Embed>', required: true, isArray: false },
      testIntersection: {
        type: 'unknown',
        allOf: [{ type: Embed }, { type: Password }],
        required: true,
        isArray: false,
      },
